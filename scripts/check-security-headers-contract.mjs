...
const EXPECTED = {
  "Content-Security-Policy": "default-src 'self'; base-uri 'self'; form-action 'self'; frame-ancestors 'none'; script-src 'self'; worker-src 'self' blob:; style-src 'self' 'unsafe-inline'; connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.ingest.de.sentry.io https://*.ingest.sentry.io; img-src 'self' data: blob: https://*.supabase.co https://*.twimg.com https://*.x.com https://*.twitter.com; media-src 'self' blob: https://*.supabase.co https://*.twimg.com https://*.x.com https://*.twitter.com;",
