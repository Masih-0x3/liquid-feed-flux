...
export function matchesMonitoringScoreBucket(post: Record<string, unknown>, bucket: MonitoringScoreBucket): boolean {
...
export function monitoringScoringV2Snapshot(post: Record<string, unknown>): Record<string, unknown> | null {
...
export function isManualScoringFeedbackEntry(entry: Record<string, unknown>): boolean {
...
export function matchesMonitoringScoringV2Filter(entry: Record<string, unknown>, filter: MonitoringFilter): boolean {
...
export function attachDuplicateClusters(entries: Record<string, unknown>[]): Record<string, unknown>[] {
...
export function matchesMonitoringFilter(entry: Record<string, unknown>, filter: MonitoringFilter): boolean {
...
// deno-lint-ignore no-explicit-any
export async function getMonitoringEntries(supabase: any, body: Record<string, unknown>) {
...
// deno-lint-ignore no-explicit-any
export async function getMonitoringOverview(supabase: any, body: Record<string, unknown>) {
