...
export function summarizeLanePressure(byType: Array<Record<string, unknown>>): Array<Record<string, unknown>> {
...
export function latestXDeliveriesByPost(rows: Array<Record<string, unknown>>): Array<Record<string, unknown>> {
...
export function summarizeDurations(values: Array<number | null>): Record<string, unknown> {
  const sorted = values
