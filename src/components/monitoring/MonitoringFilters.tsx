  ...
  return (
    <CardHeader className="p-3">
      <div className="grid gap-3 xl:grid-cols-[auto_minmax(0,1fr)] xl:items-center">
        ...
        <div className="grid gap-2 md:grid-cols-2 xl:grid-cols-[minmax(16rem,1fr)_13rem_10rem] xl:justify-end">
          ...
          <ThemedSelect value={filter} onValueChange={(value) => onFilterChange(value as MonitoringFilter)}>
            <SelectTrigger className="w-full" aria-label="Queue filter"><SelectValue /></SelectTrigger>
            <SelectContent>
          ...
          <ThemedSelect value={scoreBucket} onValueChange={(value) => onScoreBucketChange(value as ScoreBucket)}>
            <SelectTrigger className="w-full" aria-label="Score filter"><SelectValue /></SelectTrigger>
            <SelectContent>
